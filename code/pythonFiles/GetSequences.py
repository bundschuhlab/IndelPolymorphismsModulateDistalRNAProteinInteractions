...
infilenameM = "rangesBad/Ranges" + chromInput
infileM = open(infilenameM, 'r')

infilenamefai = "/home/owusuansah.10/Desktop/HumanRNA/inputdata/transcripts/transcripts.fa.fai"
infilefai = open(infilenamefai, 'r')

outfilenameM = "sequences150Bad/Sequences" + chromInput
...
for line in infileM:
    ...
    command = '/home/owusuansah.10/Desktop/HumanRNA/apps/samtools/bin/samtools faidx /home/owusuansah.10/Desktop/HumanRNA/inputdata/transcripts/transcripts.fa ' + "'" + name + "'"
    ...
    if strand == "-":
        ...
        # we don not take the reverse of these sequences because we have the transcript
        reverseSeq = seq[::-1]
    ...
    # add 1 because we want the first nuleotide to be a 1

    relativeStart = start - startFai + 1
    relativeEnd = end - startFai + 1
    relativePos = pos - startFai + 1

    # turn the the transcript sequence into a list and record its length
    ...
    if status == "D":
        ...
        # allele seq is a copy of original sequence with the ref sequences substitured for the allele
